    ...
    while True:
        try:
            ...
            if valor <1 or valor >20:
                 delay_print(f"Invalid option\nPlease only enter numbers betwen 1-20\n")
                 time.sleep(1)
                 os.system("clear")
                 continue
        except ValueError:
